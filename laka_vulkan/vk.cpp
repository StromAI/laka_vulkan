...
//    {
//        static S_allocation_callbacks cb;
//        return &cb;
//    }
//
...
//
//    Instance::Instance(
//        VkInstance handle_, S_allocation_callbacks* allocator_callbacks_ptr_)
//        :handle(handle_)
//    {
//        init_show;
//
...
//    }
//
//    Semaphore::Semaphore(shared_ptr<Device> device_, VkSemaphore handle_, const S_allocation_callbacks* allocator_)
//        :device(device_)
//        , handle(handle_)
...
//    }
//
//    Fence::Fence(shared_ptr<Device> device_, VkFence handle_, const S_allocation_callbacks* allocator_)
//        : device(device_)
//        , handle(handle_)
//        , allocation_callbacks(allocator_)
//    {    }
...
//    }
//
//    Event::Event(Device::Sptr device_, VkEvent handle_, const S_allocation_callbacks* allocator_)
//        : device(device_)
//        , handle(handle_)
//        , allocation_callbacks(allocator_)
//    {   }
...
//        const void* next_/* = nullptr*/,
//        const S_allocation_callbacks* allocator_/* = default_allocator_cb*/)
//    {
...
//    }
//
//    Buffer::Buffer(Device::Sptr device_, VkBuffer handle_, const S_allocation_callbacks* allocator_)
//        : device(device_)
//        , handle(handle_)
//        , allocation_callbacks(allocator_)
//    { }
...
//
//    Image::Image(
//        Device::Sptr device_, VkImage handle_, VkImageLayout layout_, const S_allocation_callbacks* allocator_)
//        : device(device_)
//        , handle(handle_)
//        , layout(layout_)
//        , allocation_callbacks(allocator_)
...
//        shared_ptr<Device> device_, VkQueryPool handle_, const S_allocation_callbacks* allocator_)
//        : device(device_)
//        , handle(handle_)
//        , allocation_callbacks(allocator_)
//    {   }
