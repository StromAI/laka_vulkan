...
#define load_vk_array(handle__,function__,type__,array__,...)       \
        ...
        , allocator_callbacks_ptr(allocator_callbacks_ptr_== nullptr?nullptr:&allocator_callbacks)
    {
        ...
        {
            allocator_callbacks = *allocator_callbacks_ptr_.s;
        }
        ...
        Alloc_callbacks_ptr allocator_ /*= default_allocation_cb*/)
    {
        shared_ptr<Device_creator> sptr(
            new Device_creator(
                ...
                allocator_ == &s_acb ? (Alloc_callbacks_ptr)&allocator_callbacks : allocator_)
        );
        return sptr;
    }
...
#define load_vk_device_api(api_name__) \
    ...
    shared_ptr<Buffer> Device::get_a_buffer(
        ...
        Alloc_callbacks_ptr allocator_/* = default_allocator_cb*/)
    {
